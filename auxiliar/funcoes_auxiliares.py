    ...
    if acao == 1:
        ...
        if comida == 1:
            ...
            if sorteio_comida == 1:
                ...
                print(
                    f'Hoje {personagem.nome} está com sorte! Apesar de ser no lixo conseguiu bastante sobrinhas')
            elif sorteio_comida == 2:
                personagem.muda_fome(10)
                personagem.muda_energia(5)
                personagem.muda_humor(5)
                print(
                    f'Hoje o dia não foi muito bom! {personagem.nome} teve que vasculhar em muitos lixos para conseguir comida, e algumas delas já não estavam muito boas...')
            else:
                personagem.muda_energia(-10)
                personagem.muda_humor(-5)
        ...
        if sorteio_amigo == 1:
            ...
            personagem.muda_humor(10)
            print(
                f'Hoje o mar não está para peixe, ou melhor para cachorros...{personagem.nome} procurou nos parques e nos portões das casas, mas não encontrou nenhum amigo... "Talvez seja melhor tentar mais tarde.Talvez ainda estejam dormindo", pensa nosso(a) amigo(a).')
